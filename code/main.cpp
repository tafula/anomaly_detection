...
//  outputVideo.open("demonstracao.avi", -1, 30, cv::Size(238,158), true);
  ...
  for (u32 loop_id = 0; loop_id < param_vec.n_rows; ++loop_id)
      ...
      if (first_time_entry == true)
	{
	  ...
	  /***********	AQUI TEM O NUM DE IMGS QUE ELE RECEBE *****************/
	  ad_flags.set_size(mby, mbx, nOfImages); //NUM DE IMGS QUE ELE RECEBE!
	  /***********	AQUI TEM O NUM DE IMGS QUE ELE RECEBE *****************/
      ...
      for (int seqno = 0; seqno < total_seqs; ++seqno)
	{
	  ...
	  //while(true){
		...
		// #endif
		cout << f << "/" << file_sys1.sequence_len << "\n"; //PASSOU PASSOU PASSOU PASSOU

	      }
	    
	    // if(file_sys1.tst_mask_path == "test/mask/f0/"){
	    //   file_sys1.tst_mask_path = "test/mask/f1/";
	    //   tst_img_path = "test/img/f1/";
	    // } else if(file_sys1.tst_mask_path == "test/mask/f1/"){
	    //   file_sys1.tst_mask_path = "test/mask/f0/";
	    //   tst_img_path = "test/img/f0/";	      
	    // }
